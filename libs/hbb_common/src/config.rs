...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("ar.cmc".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("CmcDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["143.198.170.154"];
pub const RS_PUB_KEY: &str = "ChbJmIG2DBN2TLjzSTSQH1afp2w7SJpwXE4C+zBn1tU=";
